...
TSharedPtr< FSlateStyleSet > FSkeletonGeneratorStyle::StyleInstance = NULL;
...
{
	static FName StyleSetName(TEXT("SkeletonGeneratorStyle"));
	return StyleSetName;
}
...
TSharedRef< FSlateStyleSet > FSkeletonGeneratorStyle::Create()
{
	...
	Style->Set("SkeletonGenerator.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
